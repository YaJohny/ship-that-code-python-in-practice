...
[![shipthatcode — Python in Practice](https://api.shipthatcode.com/cert/3a796784ccb30c3ca56bd419041b665a.svg)](https://shipthatcode.com/courses/python-in-practice)

My working repo for [Python in Practice](https://shipthatcode.com/courses/python-in-practice) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Python in Practice"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/python-in-practice) ("Work in your own editor" → **Link repo**). Done — you never do this again.
